...
(function () {
    ...
    $("#addExhibition").click(function () {
        document.getElementById("exhibition").innerHTML += '<div class="discovered-item" >' +
            '<img src="images/cabin.png" class="img-rounded img-responsive" alt="cabin" />' +
            '</div >'
